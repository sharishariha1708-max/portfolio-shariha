  ...
  return (
    <section id="home" className="min-h-screen relative flex items-center justify-center pt-20 pb-10 overflow-hidden bg-[#0A1628]">
      ...
      <div className="container relative z-10 flex flex-col md:flex-row items-center gap-12 w-full">
        ...
        {/* Content */}
        <div className={`w-full max-w-4xl mx-auto flex flex-col items-center text-center transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-x-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-4 tracking-tight">
            SHARIHA SRI S
          </h1>
          <h2 className="text-xl md:text-2xl font-bold text-[#4DD0E1] mb-6">
            AWS Cloud Engineer | Python | SQL
          </h2>
          <p className="text-lg text-[#B0BEC5] mb-8 max-w-3xl leading-relaxed">
            AWS Cloud Engineer with hands-on experience in Python, SQL, and AWS. Passionate about building secure, scalable, and cost-efficient cloud solutions, managing infrastructure, and exploring cloud architecture.
          </p>
          ...
          <div className="flex gap-6 justify-center">
            <a href="https://www.linkedin.com/in/shariha-sri-s-shariha-sri-s-969abb280/" target="_blank" rel="noopener noreferrer" className="text-[#9E9E9E] hover:text-[#00BCD4] transition-colors transform hover:scale-110">
              <span className="sr-only">LinkedIn</span>
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
            <a href="https://github.com/sharishariha1708-max" target="_blank" rel="noopener noreferrer" className="text-[#9E9E9E] hover:text-[#00BCD4] transition-colors transform hover:scale-110">
            ...
            <a href="mailto:sharishariha1708@gmail.com" className="text-[#9E9E9E] hover:text-[#00BCD4] transition-colors transform hover:scale-110">
